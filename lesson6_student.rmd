...
m1<-lm(diamondsbig$logprice~I(diamondsbig$carat^(1/3)),
       data=diamondsbig[diamondsbig$price<10000 &
                          diamondsbig$cert=='GTA'])

m2<-update(m1, ~ . +diamondsbig$carat)
m3<-update(m2, ~ . +diamondsbig$cut)
m4<-update(m3, ~ . +diamondsbig$color)
m5<-update(m4, ~ . +diamondsbig$clarity)
mtable(m1,m2,m3,m4,m5)
